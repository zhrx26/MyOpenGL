...
glm::vec3 fLightPos(1.2f, 1.0f, 2.0f);
...
int main()
{
	...
	// 创建封装过的Shader对象
	Shader pShader("2.1.colors.vs", "2.1.colors.fs");
	Shader pLampShader("2.1.lamp.vs", "2.1.lamp.fs");
	...
	while (!glfwWindowShouldClose(pWindow))
	{
		...
		pLampShader.Use();
		mModel = glm::mat4();
		mModel = glm::translate(mModel, fLightPos);
